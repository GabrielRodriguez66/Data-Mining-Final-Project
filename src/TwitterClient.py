...
from src import API_KEY, API_SECRET_KEY, ACCESS_TOKEN, ACCESS_TOKEN_SECRET
...
class TwitterClient:
    ...
    def get_tweets(self, query, date_since=None, count=10):
    ...
    def get_df(self):
        ...
        return pd.DataFrame(data=tweet_list, columns=['Username', 'Tweet', 'Sentiment_Value'])
